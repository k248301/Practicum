...
class TradeLocators:
    ...
    HISTORY_TABLE = (By.ID, "historyDataTable")
    HISTORY_ROWS = (By.CSS_SELECTOR, "#historyDataTable tbody tr")
    START_DATE = (By.ID, "startDate")
    END_DATE = (By.ID, "endDate")
    FILTER_HISTORY_BTN = (By.ID, "filterHistoryBtn")
    RESET_HISTORY_BTN = (By.ID, "resetHistoryBtn")
